...
import { User, Mail, Lock, AlertCircle, Shield, Crown } from 'lucide-react';
        ...
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-50 to-white dark:from-gray-900 dark:to-gray-800">
            ...
            <div className="flex-1 flex items-center justify-center p-4">
                <div className="w-full max-w-5xl px-4">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-12 border border-purple-200 dark:border-purple-900">
                        {/* Title */}
                        <div className="text-center mb-10">
                            ...
                            <p className="text-lg text-muted-foreground">Create administrator account</p>
                            <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-50 dark:bg-purple-950 border border-purple-200 dark:border-purple-800">
                                <Crown className="h-4 w-4 text-purple-600" />
                                <span className="text-sm font-medium text-purple-900 dark:text-purple-100">Full system access & user management</span>
                            </div>
                        </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        required
                                        disabled={isLoading}
                                        className="h-14 text-base pl-12 border-purple-200 focus:border-purple-500"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="text-center mt-8 space-y-3">
                            ...
                            <div className="mt-6">
                                ...
                                <Link href="/auth/login/admin" className="text-purple-600 hover:underline font-semibold">
                                    Sign in as Admin
                                </Link>
                            </div>
                        </div>
